...
local function BBAH_fake_script() -- ScreenGui.ScreenGui.LocalScript 
	...
	local function closeGui()
		...
		-- Przywracamy rozmiar do nastêpnego otwarcia
...
local function IZYAL_fake_script() -- ScreenGui.ScreenGui.LocalScript 
	...
	local dragArea = mainFrame:WaitForChild("FrameLayout") -- ten twój frame w œrodku
...
local function FLYMCOB_fake_script() -- ScreenGui.TextButton.LocalScript 
	...
	button.MouseButton1Click:Connect(function()
		if not activated then
			-- Powiêkszamy HumanoidRootPart od razu o 40 w ka¿dej osi
...
local function CLCH_fake_script() -- ScreenGui.TextButton_3.LocalScript 
	...
	-- Funkcja tworz¹ca aimbot GUI i logikê
	local function createAimbot()
		...
		-- ====== USTAWIENIA ======
		local FOV_RADIUS = 150 -- wielkoœæ kó³ka
	...
	-- Klikniêcie TextButton uruchamia aimbota
...
local function EXCMQJO_fake_script() -- ScreenGui.KeyFrame.LocalScript 
	...
	local screenGui = playerGui:WaitForChild("ScreenGui") -- JEŒLI MASZ INN¥ NAZWÊ, ZMIEÑ TUTAJ
